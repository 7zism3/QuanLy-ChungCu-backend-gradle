...
import com.nhom43.quanlychungcubackendgradle.controller.UserController;
...
public class UserControllerTest {
    ...
    public void update() throws Exception {
        Mockito.when(userService.update(ArgumentMatchers.any(), ArgumentMatchers.anyLong())).thenReturn(UserBuilder.getDto());
